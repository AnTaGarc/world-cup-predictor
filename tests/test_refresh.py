...
class RefreshTests(unittest.TestCase):
    def test_command_has_no_odds_provider_arguments(self):
        ...
        self.assertNotIn("--max-odds-credits", command)

    def test_command_is_bounded(self):
        command = build_collect_command(
    ...
    def test_refresh_result_surfaces_providers_missing_and_stderr(self):
        ...
        self.assertFalse(hasattr(result, "odds_providers"))
